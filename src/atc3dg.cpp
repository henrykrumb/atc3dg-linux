...
void ATC3DGTracker::update(
	...
	// positions
	x = 36.0 * m_scaling * p_get_double(0, 1);
	y = 36.0 * m_scaling * p_get_double(2, 3);
	z = 36.0 * m_scaling * p_get_double(4, 5);
	// angles
	ax = 180.0 * p_get_double(6, 7);
	...
	qi = p_get_double(22, 23);
	qj = p_get_double(24, 25);
	qk = p_get_double(26, 27);
	// quality
